...
import { PencilFill, PersonSquare } from "react-bootstrap-icons";
...
const EditManager = () => {
    ...
    const fetchManagerData = async (id) => {
        try {
            ...
            setToastMsg("Error fetching manager information!");
        }
    }
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                const response = await axios.patch(`http://localhost:3500/api/managers/${id}`, formData, {
    ...
    const { name, phone, email, image } = values;
    ...
    return (
        <>
            <div className="main">
                ...
                <div className="right">
                    <Navbar parentPage='Managers' parentRoute='/managers' childPage='Edit' />

                    <div className="content">

                        <PageHeader pageTitle='Edit Manager' actionName='Enroll Student' actionLink='/students/enroll' />
                        ...
                        <div className="body">
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Button variant="primary" type="submit">
                                    {loading ? <Spinner size="sm" animation="border" /> : <PencilFill />} Update Manager
                                </Button>
                            </Form>
