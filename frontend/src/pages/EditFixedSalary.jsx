    ...
    const fetchSalaryInfo = async () => {
        try {
            ...
            formik.setValues({
                ...
                "monthOfSalary": response.data.data[0].details,
            });
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                const response = await axios.patch(`http://localhost:3500/api/salaries/edit/fixed-type/${salaryInfo.salary_id}`, values);
            ...
            <div className="main">
                ...
                <Navbar parentPage='Paid Salaries' parentRoute='/paid-salaries' childPage='Edit' />
                    <div className="content">
                        ...
                        <PageHeader pageTitle={`Edit Paid salary - Total: ${salaryInfo.total_amount}`} actionName='Enroll Student ' actionLink='/students/enroll' />
...
export default EditFixedSalary;
