...
import { PenFill, PencilFill } from "react-bootstrap-icons";
...
const EditBook = () => {
    ...
    const fetchBookData = async (id) => {
        try {
            ...
            setToastMsg("Error fetching book information!");
        }
    }
    ...
    const validationSchema = Yup.object({
        title: Yup.string().trim().required("Book Title is required").max(50, "The maximum value allowed is 50"),
        author: Yup.string().trim().required("Author Name is required").max(150, "The maximum value allowed is 150"),
        price: Yup.number().required("Price is required").positive('The value should be positive').min(0, "The maximum value allowed is 0").max(9999, "The maximum value allowed is 9999"),
        quantity: Yup.number().required("Book quantity is required").positive('The value should be positive').min(0, "The maximum value allowed is 0").max(99999, "The maximum value allowed is 99999"),
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                const response = await axios.patch(`http://localhost:3500/api/books/${id}`, values);
                ...
                if (response.data.statusCode === 200) {
                    ...
                    setShowToast(true);
                    setToastStatus("Error");
                    setToastMsg("Error updating book record!");
                }
    ...
    return (
        <>
            <div className="main">
                ...
                <div className="right">
                    <Navbar parentPage='Books' parentRoute='/books' childPage='Edit' />
                    <div className="content">

                        <PageHeader pageTitle='Edit Book' actionName='Enroll Student' actionLink='/students/enroll' />
                        ...
                        <div className="body">
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Button variant="primary" type="submit">
                                    {loading ? <Spinner size="sm" animation="border" /> : <PencilFill />} Update Book
                                </Button>
                            </Form>
