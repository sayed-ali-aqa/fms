...
const AddEmployee = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                const response = await axios.post('http://localhost:3500/api/employees/new', formData, {
    ...
    const { name, gender, phone, position, education, address, paymentType, paymentValue, categoryId, branchId } = values;
    ...
    return (
        <>
            <div className="main">
                ...
                <div className="right">
                    <Navbar parentPage='Employees' parentRoute='/employees' childPage='Add' />
                    <div className="content">

                        <PageHeader pageTitle='Add Employee' actionName='Enroll Student' actionLink='/students/enroll' />
                        ...
                        <div className="body">
                            <Form onSubmit={handleSubmit} encType='multipart/form-data'>
                                ...
                                <Button className="mt-2" variant="primary" type="submit">
                                    {loading ? <Spinner size="sm" animation="border" /> : <PlusLg />} Add Employee
                                </Button>
                            </Form>
