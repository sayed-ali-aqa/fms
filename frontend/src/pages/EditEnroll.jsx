    ...
    const fetchEnrollData = async () => {
        try {
            ...
            formik.setValues({
                ...
                classId: response.data.data[0].class_id,
            });
        } catch (error) {
            setShowToast(true);
            setToastStatus("Error");
            setToastMsg("Error fetching enroll info!");
        }
    }
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                const response = await axios.patch(`http://localhost:3500/api/enrolls/edit/${id}`, values);
    ...
    return (
        <>
            <div className="main">
                ...
                <div className="right">
                    <Navbar parentPage='Enrolls' parentRoute='/enrolls' childPage='Edit' />
                    <div className="content">

                        <PageHeader pageTitle='Edit Enroll' actionName='Add Student' actionLink='/students/new' />
                        ...
                        <div className="body">
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Button variant="primary" type="submit">
                                    {loading ? <Spinner size="sm" animation="border" /> : <PencilFill />} Update Enroll
                                </Button>
                            </Form>
